...
@section('content')
    <div class="container">
        ...
        <div class="table-responsive">
                        ...
                        <tr class="table-secondary">
                            ...
                            <td class="align-middle">
                                ...
                                <a class="text-black" href="{{ $project->public_link }}"><svg
                                        xmlns="http://www.w3.org/2000/svg" height="2em" fill="currentColor"
            ...
            <!--DA RIAGGIUNGERE DOPO AVER SISTEMATO IL FETCH GITHUB-->
            <!--<a class="btn btn-dark mx-1 d-flex align-items-center" href="">
